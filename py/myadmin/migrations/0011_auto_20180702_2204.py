# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-07-02 22:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myadmin', '0010_auto_20180701_1916'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='orders',
            options={'permissions': (('show_orders', '查看订单管理'), ('insert_orders', '添加订单'), ('edit_orders', '修改订单'), ('del_orders', '删除订单'))},
        ),
        migrations.AlterModelOptions(
            name='types',
            options={'permissions': (('show_types', '查看分类管理'), ('insert_types', '添加分类'), ('edit_types', '修改分类'), ('del_types', '删除分类'))},
        ),
        migrations.AlterModelOptions(
            name='users',
